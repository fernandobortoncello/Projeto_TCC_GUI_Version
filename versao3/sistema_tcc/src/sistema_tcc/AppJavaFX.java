...
public class AppJavaFX extends Application {
    ...
    public void start(Stage stagePrincipal) {
        ...
        // (CORREÇÃO DE ERRO 5) Popular TCCs de exemplo (agora depende de Alunos e Professores)
        ((MockTccRepositorio)tccRepositorio).popularDadosDemo(
                alunoRepositorio,
        ...
        // (CORREÇÃO DE ERRO 6) TccServico agora também precisa do AlunoRepositorio
        TccServico tccServico = new TccServico(tccRepositorio, professorRepositorio, alunoRepositorio);
